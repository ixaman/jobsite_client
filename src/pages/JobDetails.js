...
const JobDetails = () => {
  ...
  const [applyJob] = useApplyPostMutation();
  const [postQuestion] = useQustionsMutation();
  ...
  const handleApply = () => {
    ...
    if (applicants?.some((item) => data.userId === item.id)) {
